    ...
    <>
      ...
      <div style={navyCard}>
        <div style={{ fontSize: 11, fontWeight: 700, color: C.teal, textTransform: "uppercase", letterSpacing: "1px", marginBottom: 10, paddingBottom: 4, borderBottom: "1px solid rgba(14,165,233,0.25)" }}>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
            <FiCalendar size={12} style={{ color: C.teal }} /> Protocol Duration & Frequency
          </span>
        </div>
        <div style={S.grid(3)}>
          <div>
          ...
          <div>
            ...
            <select style={{ ...S.select, width: "100%", border: `1.5px solid ${C.border}` }} value={form.sessionFrequency} onChange={e => setField("sessionFrequency", e.target.value)}>
              ...
              <option value="5">5x per week (Inpatient / Acute)</option>
            </select>
          </div>
          <div>
        ...
        {complianceOpen && (
          <div style={{
            ...
            <div style={{ fontSize: 10, color: C.text, lineHeight: 1.7, marginBottom: 6 }}>
              K9 Rehab Pro operates as a Clinical Decision-Support System (CDSS). All generated protocols must be reviewed and approved by a licensed veterinarian before clinical use. The platform does not establish a VCPR, diagnose conditions, or prescribe medications.
            </div>
            <ul style={{ fontSize: 10, color: C.text, lineHeight: 1.8, margin: "0 0 8px 16px", padding: 0 }}>
              <li>All patient data stored locally — no external transmission</li>
              <li>No third-party data sharing or AI training on user data</li>
              <li>Evidence-based exercise library validated against source-of-truth documents</li>
              <li>Protocols follow ACVSMR-aligned best practices</li>
              <li>Final clinical decisions remain the responsibility of the supervising veterinarian</li>
            </ul>
      ...
      <div style={{
        ...
        >
          <span style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <TbPaw size={20} />
            {loading ? "GENERATING PROTOCOL..." : "GENERATE EVIDENCE-BASED PROTOCOL"}
          </span>
          <span style={{ fontSize: 10, fontWeight: 500, letterSpacing: "0.3px", opacity: 0.85 }}>
            Species-matched &middot; Vet-approved &middot; Contraindication-checked
          </span>
        </button>
      </div>
      ...
      <div style={{ display: "flex", justifyContent: "flex-start", padding: "8px 0" }}>
        <button
          ...
          onClick={() => goToStep(6)}
        >
          &larr; Back to Equipment & Modalities
        </button>
      </div>
    </>
  );
