...
import { FiUsers, FiChevronRight, FiAlertTriangle } from "react-icons/fi";
import { TbDog } from "react-icons/tb";
import C from "../../constants/colors";
import S from "../../constants/styles";
import SectionHead from "./SectionHead";
import StepNavButtons from "./StepNavButtons";
import { BREEDS, HOSPITALS } from "./constants";
      ...
      <div style={{ background: C.navy, border: `1px solid ${C.navy}`, borderRadius: 10, padding: "16px 20px", marginBottom: 12, color: "#fff" }}>
        ...
        <div style={S.grid(2)}>
          <div>
            ...
            <input style={{ ...S.input, border: `1.5px solid ${C.border}` }} value={form.clientName} onChange={e => setField("clientName", e.target.value)} placeholder="Last, First" />
          </div>
          <div>
        ...
        <div style={{ ...S.grid(3), marginTop: 12 }}>
          <div>
            ...
            <input style={{ ...S.input, border: `1.5px solid ${C.border}` }} value={form.clientPhone} onChange={e => setField("clientPhone", e.target.value)} placeholder="(555) 000-0000" />
          </div>
          <div>
            <label style={S.label}>Secondary Phone (Optional)</label>
            <input style={{ ...S.input, border: `1.5px solid ${C.border}` }} value={form.clientPhone2} onChange={e => setField("clientPhone2", e.target.value)} placeholder="(555) 000-0000" />
          </div>
          <div>
        ...
        <div style={{ ...S.grid(3), marginTop: 12 }}>
          <div>
            ...
            <input style={{ ...S.input, border: `1.5px solid ${C.border}` }} value={form.referringClinicPhone} onChange={e => setField("referringClinicPhone", e.target.value)} placeholder="(555) 000-0000" />
          </div>
          <div>
