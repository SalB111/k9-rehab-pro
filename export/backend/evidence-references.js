...
const EXERCISE_EVIDENCE_MAP = {
  ...
  WHEEL_BARREL:     ['MILLIS_LEVINE_2014', 'STRENGTHENING_TPLO'],
  ...
  POOL_SWIM_HYDRO:  ['SWIMMING_STUDY', 'UWT_STUDY'],
  POOL_TREADING:    ['SWIMMING_STUDY', 'UWT_EMG_STUDY'],
  HYDRO_JETS:       ['UWT_STUDY', 'MASSAGE_STUDY'],
  WADING_WALK:      ['UWT_STUDY', 'THERAPEUTIC_EX_OA'],
  ...
  // --------------------------------------------------------------------------
  // GERIATRIC CARE (15 exercises)
  // --------------------------------------------------------------------------
  GENTLE_PROM:         ['PROM_CCL', 'GERIATRIC_OA', 'MILLIS_LEVINE_2014'],
  SENIOR_WALK:         ['GERIATRIC_EXERCISE', 'THERAPEUTIC_EX_OA', 'GERIATRIC_OA'],
  MASSAGE_SENIOR:      ['MASSAGE_STUDY', 'GERIATRIC_OA'],
  SIT_STAND_SENIOR:    ['SIT_STAND_STUDY', 'GERIATRIC_EXERCISE'],
  ...
  HEAT_THERAPY_GERI:   ['HEAT_THERAPY_REF', 'GERIATRIC_OA'],
  COLD_THERAPY_GERI:   ['CRYO_THERAPY', 'GERIATRIC_OA'],
  ...
  // --------------------------------------------------------------------------
  // NEUROLOGICAL REHAB (15 exercises)
  // --------------------------------------------------------------------------
  NEURO_PROM:          ['PROM_CCL', 'IVDD_REHAB', 'MILLIS_LEVINE_2014'],
  ...
  // --------------------------------------------------------------------------
  // COMPLEMENTARY THERAPY (15 exercises)
  // --------------------------------------------------------------------------
  LASER_THERAPY:   ['LASER_CLASS4', 'LASER_IVDD'],
  THERAPEUTIC_US:  ['ULTRASOUND_STUDY', 'MILLIS_LEVINE_2014'],
  ESTIM:           ['NMES_STUDY', 'TENS_STUDY', 'MILLIS_LEVINE_2014'],
  TENS:            ['TENS_STUDY', 'MILLIS_LEVINE_2014'],
  ACUPUNCTURE:     ['ACUPUNCTURE_VET', 'MCGONAGLE_2018'],
  CHIROPRACTIC:    ['JOINT_MOB_STUDY', 'MILLIS_LEVINE_2014'],
  MYOFASCIAL:      ['MYOFASCIAL_STUDY', 'MASSAGE_STUDY'],
  KINESIO_TAPE:    ['KINESIO_TAPE', 'MILLIS_LEVINE_2014'],
  PULSED_EMF:      ['PEMF_STUDY', 'MILLIS_LEVINE_2014'],
  ...
  ASSISI_LOOP:     ['PEMF_STUDY', 'MILLIS_LEVINE_2014'],
