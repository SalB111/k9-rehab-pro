...
const EXERCISE_EVIDENCE_MAP = {
  ...
  // --------------------------------------------------------------------------
  // PHASE-SPECIFIC UWTM & AQUATIC PROTOCOLS (Part 11 — 12 exercises)
  // --------------------------------------------------------------------------
  UWTM_PHASE1:        ['UWT_STUDY', 'MILLIS_LEVINE_2014'],
  UWTM_PHASE2:        ['UWT_STUDY', 'MILLIS_LEVINE_2014', 'SWIMMING_STUDY'],
  UWTM_PHASE3:        ['UWT_STUDY', 'MILLIS_LEVINE_2014', 'SWIMMING_STUDY'],
  UWTM_PHASE4:        ['UWT_STUDY', 'MILLIS_LEVINE_2014'],
  UWTM_NEURO:         ['UWT_STUDY', 'NEURO_REHAB_STUDY', 'MILLIS_LEVINE_2014'],
  UWTM_OBESITY:       ['UWT_STUDY', 'SWIMMING_STUDY', 'MILLIS_LEVINE_2014'],
  UWTM_GERIATRIC:     ['UWT_STUDY', 'GERIATRIC_OA', 'MILLIS_LEVINE_2014'],
  UWTM_INCLINE:       ['UWT_STUDY', 'UWT_EMG_STUDY', 'MILLIS_LEVINE_2014'],
  UWTM_POST_TPLO:     ['UWT_STUDY', 'STRENGTHENING_TPLO', 'MILLIS_LEVINE_2014'],
  POOL_SUPPORTED:      ['SWIMMING_STUDY', 'MILLIS_LEVINE_2014'],
  POOL_THERAPEUTIC:    ['SWIMMING_STUDY', 'UWT_STUDY', 'MILLIS_LEVINE_2014'],
  UWTM_HIP_DJD:       ['UWT_STUDY', 'HIP_OA_EXERCISE', 'MILLIS_LEVINE_2014'],

  // --------------------------------------------------------------------------
  // SOFT TISSUE, SPORT CONDITIONING & RETURN TO FUNCTION (Part 12 — 10 exercises)
  // --------------------------------------------------------------------------
  ILIO_STRETCH:        ['MILLIS_LEVINE_2014', 'MASSAGE_STUDY'],
  ILIO_ECCENTRIC:      ['MILLIS_LEVINE_2014', 'STRENGTHENING_TPLO'],
  GRACILIS_RELEASE:    ['MILLIS_LEVINE_2014', 'MASSAGE_STUDY'],
  BICEPS_PROM:         ['MILLIS_LEVINE_2014', 'PROM_STUDY'],
  BICEPS_ACTIVE:       ['MILLIS_LEVINE_2014', 'STRENGTHENING_TPLO'],
  CORE_BRIDGE:         ['BALANCE_STUDY', 'MILLIS_LEVINE_2014'],
  CORE_CRAWL:          ['NEURO_REHAB_STUDY', 'MILLIS_LEVINE_2014'],
  SPORT_WEAVE:         ['SPORT_CONDITIONING', 'MILLIS_LEVINE_2014'],
  SPORT_JUMP_PREP:     ['SPORT_CONDITIONING', 'MILLIS_LEVINE_2014'],
  ELBOW_LOAD_PROG:     ['MILLIS_LEVINE_2014', 'STRENGTHENING_TPLO'],

  // --------------------------------------------------------------------------
  // FELINE REHABILITATION (Part 13 — 15 exercises)
  // Evidence: Adapted from canine literature + Sharp 2012 feline rehab
  // --------------------------------------------------------------------------
  FELINE_PROM:         ['PROM_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_MASSAGE:      ['MASSAGE_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_WAND_AROM:    ['MILLIS_LEVINE_2014'],
  FELINE_TREAT_SHIFT:  ['BALANCE_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_THREE_LEG:    ['BALANCE_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_WOBBLE:       ['WOBBLE_BOARD_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_CAVALETTI:    ['CAVALETTI_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_STAIR_WAND:   ['STRENGTHENING_TPLO', 'MILLIS_LEVINE_2014'],
  FELINE_STAND_ROLL:   ['NEURO_REHAB_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_UWTM:         ['UWT_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_PBMT:         ['LASER_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_TENS:         ['TENS_STUDY', 'MILLIS_LEVINE_2014'],
  FELINE_SIT_STAND:    ['STRENGTHENING_TPLO', 'MILLIS_LEVINE_2014'],
  FELINE_ENVIRON_MOD:  ['GERIATRIC_OA', 'MILLIS_LEVINE_2014'],
  FELINE_THERMAL:      ['CRYO_STUDY', 'MILLIS_LEVINE_2014']
};
